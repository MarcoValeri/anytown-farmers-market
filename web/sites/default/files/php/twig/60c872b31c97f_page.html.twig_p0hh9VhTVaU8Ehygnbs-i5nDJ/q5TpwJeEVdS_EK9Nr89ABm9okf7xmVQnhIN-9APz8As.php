...
<html lang=\"en\">
    ...
    <body>
        ...
        echo "
            <nav class=\"menu\">
                ";
        // line 11
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["page"] ?? null), "menu", [], "any", false, false, true, 11), 11, $this->source), "html", null, true);
        echo "
            </nav>
        </header>
        <main class=\"main\">
        ...
        echo "
            ...
            ";
        // line 18
        if (twig_get_attribute($this->env, $this->source, ($context["page"] ?? null), "sidebar", [], "any", false, false, true, 18)) {
            // line 19
    ...
    {
        return array (  79 => 25,  75 => 23,  69 => 19,  67 => 18,  62 => 16,  54 => 11,  49 => 9,  39 => 1,);
    }
